...
_action = ["GRAD_leaveNotes_inspectNoteGround", "Inspect Note", GRAD_leaveNotes_moduleRoot + "\data\inspect.paa", {[(_this select 0) getVariable ["handwriting", ["",""]]] call GRAD_leaveNotes_fnc_inspectNote}, {player getVariable ["GRAD_leaveNotes_canInspect", GRAD_leaveNotes_canInspectDefault]}] call ace_interact_menu_fnc_createAction;
[_note, 0, ["GRAD_leaveNotes_mainActionGround"], _action] call ace_interact_menu_fnc_addActionToObject;
