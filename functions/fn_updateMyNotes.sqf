...
if (_mode == "remove") then {
    ...
    //remove main node
    if (!(player getVariable ["GRAD_leaveNotes_canWriteNotes", GRAD_leaveNotes_canWriteDefault]) && (player getVariable ["GRAD_leaveNotes_notesInInventory", 0]) == 0) then {
...
if (_mode == "add") then {
    ...
    if (!(player getVariable ["GRAD_leaveNotes_canWriteNotes", GRAD_leaveNotes_canWriteDefault]) && (player getVariable ["GRAD_leaveNotes_notesInInventory", 0]) == 1) then {
        _action = ["GRAD_leaveNotes_mainAction", "My notes", GRAD_leaveNotes_moduleRoot + "\data\note.paa", {}, {true}] call ace_interact_menu_fnc_createAction;
